...
function Shell({ children }: Readonly<PropsWithChildren>) {
  return (
  ...
  return (
    <Shell>
      ...
      <div className='font-bold'>
        ...
        <div className='mb-12 mt-8 flex flex-col flex-wrap gap-x-6 gap-y-2 sm:max-lg:h-32 xl:mb-16 xl:h-40'>
